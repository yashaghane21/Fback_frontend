...
const Dash = () => {
    const { theme } = useAuth()
    return (
        <div className={` ${theme == "light" ? "bg-[#f5f1f0]" : " bg-[#0c131d]"} flex sm:h-[100vh] h-[65vh]  flex-col-reverse sm:flex-row  p-5`}>
            <div className='w-[100%] sm:w-[50%] p-3 flex justify-center items-center'>
                <img src={img} className='w-[80%] sm:w-[90%] h-[100%] border-2 border-black rounded-2xl sm:h-[50%]' />
            </div>
