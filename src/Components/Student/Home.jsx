    ...
    return (
        <div className={`${theme == "light" ? "text-black" : "bg-[#1d232a] text-black"} h-[91vh] overflow-y-auto p-5 w-full`}>
            ...
            <div className='flex justify-center sm:justify-start items-center'>
                ...
                <div onClick={() => navigate("/student/cof")} className={`h-[20vh]  mx-5  my-5 w-[50vh]   hover:shadow-md rounded-lg cursor-pointer ${theme == "light" ? " bg-[#f5f1f0] shadow-lg" : "bg-[#0c131d] shadow-xl text-white"}`}>
                    ...
                    <div onClick={() => navigate("/student/ecf")} className={`h-[20vh]  mx-5  my-5 w-[50vh]   hover:shadow-md rounded-lg cursor-pointer ${theme == "light" ? " bg-[#f5f1f0] shadow-lg" : "bg-[#0c131d] shadow-xl text-white"}`}>
                        <div className='flex justify-between items-center p-5 h-[15vh] '>
