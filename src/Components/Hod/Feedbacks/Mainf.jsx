            ...
            {loader ? <section className='flex justify-center items-center h-[50vh]'>
                ...
                <div className='p-5'>
                    {fbacks.feedback?.map((item, index) => (
                        <section className={`h-[13vh] w-full my-5 select-none  rounded-lg shadow-2xl flex sm:justify-between flex-row ${theme == "light" ? "bg-white text-black shadow-lg" : "bg-black text-white  shadow-black shadow-md"}`} key={index} >
