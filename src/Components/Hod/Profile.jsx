            ...
            <div className='flex flex-row w-[100%]'>
                <div className={`w-[27%] h-[91vh] border-r-2 hidden sm:block ${theme == "light" ? "bg-white" : "bg-[#1d232a]"}`}>
                    <ul className='font-bold p-2   '>
                        <li onClick={() => navigate("/hod/profile/view")} className={`${disActive("/hod/profile/view")} ${theme == "light" ? "text-black" : "text-white"} w-[250px] my-2 flex py-1 px-2 hover:bg-blue-600 rounded-lg `}> <CgProfile size={23} className='flex  mx-4' />View profile </li>
                        <li onClick={() => navigate("/hod/profile/edit")} className={`${disActive("/hod/profile/edit")} ${theme == "light" ? "text-black" : "text-white"} w-[250px] my-2 flex py-1 px-2 hover:bg-blue-600  rounded-lg`}> <BiEditAlt size={23} className='flex  mx-4' />Edit profile </li>
